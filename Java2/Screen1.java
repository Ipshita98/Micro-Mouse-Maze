...
public class Screen1 extends javax.swing.JFrame {
    ...
    static public int INTERVAL = 1000; // timer update interval = 1000ms
    
    private DisplayManager mgr;
    static Timer timer1;
    private int counter=0;
    static int Screen1Flag=0;
    /**
     * Creates new form Screen1
     */
    public Screen1(DisplayManager mgr) {
        this.mgr = mgr;
        
        initComponents();
        this.label1.setText("Steps moved by mouse!!");
         // initialise Timer
        timer1 = new Timer(INTERVAL, new java.awt.event.ActionListener() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.timer1.stop();
        Screen1Flag=0;//used for initiating mouse action
        new displayMaze();
    ...
    private void timerActionPerformed(java.awt.event.ActionEvent evt)            {                                        
        // update counter and refresh label
        this.counter++;
        this.label1.setText(Integer.toString(this.counter));
    } 
